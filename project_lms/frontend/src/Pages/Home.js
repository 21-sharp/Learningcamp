    ...
    <div className="bg-base-100 min-h-screen">
      ...
      <section className="relative overflow-hidden pt-12 pb-24 lg:pt-20 lg:pb-32">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <img
            src={require("../images/home_bg.png")}
            alt="background"
            className="w-full h-full object-cover opacity-30 grayscale-[20%] scale-105"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-base-100/10 via-base-100/50 to-base-100" />
        </div>

        <div className="container mx-auto px-4 lg:px-12 flex flex-col lg:flex-row items-center gap-12 lg:gap-20 relative z-10">
          <div className="flex-1 text-center lg:text-left z-10 order-2 lg:order-1">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-base-content mb-8 leading-[1.1] tracking-tight">
              Unlock Your Potential <br />
              <span
                className="text-transparent bg-clip-text"
                style={{
                  backgroundImage: 'linear-gradient(135deg, hsl(var(--p)), hsl(var(--a)))',
          ...
          <div className="flex-1 flex justify-center lg:justify-end relative order-1 lg:order-2 w-full max-w-lg lg:max-w-none mx-auto">
            ...
            <div className="relative group w-full aspect-square max-w-[500px]">
              ...
              <div className="relative w-full h-full rounded-[40px] bg-base-100/50 backdrop-blur-sm border border-white/20 shadow-2xl flex items-center justify-center overflow-hidden transform transition duration-500 hover:rotate-1 hover:scale-[1.02]">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-accent/5"></div>
                <img
                  src={require("../images/hero_photo.png")}
                  alt="Hero"
                ...
                <div className="absolute bottom-20 left-10 w-14 h-14 bg-base-100 border border-base-200 shadow-xl rounded-2xl flex items-center justify-center text-2xl" style={{ animation: "float 4s ease-in-out infinite 0.5s" }}>🚀</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-base-200 py-16 border-y border-base-300">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { label: "Active Courses", value: "200+", icon: "📚" },
              { label: "Expert Instructors", value: "50+", icon: "👨‍🏫" },
              { label: "Students Worldwide", value: "10k+", icon: "🌍" },
              { label: "Satisfaction Rate", value: "99%", icon: "⭐" },
            ].map((stat, i) => (
      ...
      <section className="py-20 container mx-auto px-4 lg:px-12">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-extrabold text-base-content mb-4 tracking-tight">
            Why Choose <span className="text-primary">LearningCamp</span>?
          </h2>
          ...
          {[
            {
              ...
              desc: "Learn from industry professionals with years of real-world experience and get practical, applicable knowledge.",
              color: "from-primary/10 to-primary/5"
            },
            {
              icon: "🏆",
              title: "Earn Certificates",
              desc: "Get recognized for your achievement with professional certificates that you can share with employers.",
              color: "from-secondary/10 to-secondary/5"
            },
            {
              icon: "📊",
              title: "Track Progress",
              desc: "Monitor your learning journey with detailed analytics, points, and achievement badges.",
              color: "from-accent/10 to-accent/5"
            }
          ].map((feature, i) => (
            <div key={i} className={`card bg-gradient-to-br ${feature.color} shadow-sm hover:shadow-xl transition-all duration-300 border border-base-200 hover:-translate-y-2`}>
              <div className="card-body text-center p-8">
                <div className="text-5xl mb-4">{feature.icon}</div>
                <h3 className="text-xl font-bold mb-3">{feature.title}</h3>
                <p className="text-base-content/60 leading-relaxed text-sm">{feature.desc}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-accent text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/80 mb-10 max-w-2xl mx-auto">
            Join thousands of students who are already transforming their careers with LearningCamp.
          </p>
          <div className="flex justify-center gap-4 flex-wrap">
            <button
              onClick={() => navigate("/register")}
              className="btn btn-lg rounded-2xl bg-white text-primary font-bold px-12 border-0 shadow-xl hover:bg-base-100 hover:scale-105 transition-all"
            >
              Get Started Free
            </button>
            <button
              onClick={() => navigate("/courses")}
              className="btn btn-lg rounded-2xl btn-outline text-white border-white/30 hover:bg-white/10 hover:border-white font-bold px-12 transition-all"
            >
              Browse Courses
            </button>
          </div>
